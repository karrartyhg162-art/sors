# [Smart Guard](https://t.me/SI0lZ) - zthon
# Copyright (C) 2022 [Smart Guard](https://t.me/SI0lZ) . All Rights Reserved
#< https://t.me/Smart Guard >
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                buttons=[(Button.url("𝙕𝙀𝘿𝙏𝙝𝙤𝙣𓅛", "https://t.me/SI0lZ"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def mybot():
    ...
    if gvarstatus("bot_setup_done") or bot_name.endswith("Assistant"):
        print("تم تشغيل البوت بنجــاح")
    else:
        addgvar("bot_setup_done", "true")
        try:
            await bot.send_message("@BotFather", "/setinline")
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "SI0lZ")
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zthon/zilzal/logozed.jpg")
