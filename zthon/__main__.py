...
from zthon.utils import mybot
from zthon.utils import add_bot_to_logger_group, load_plugins, setup_bot, startupmessage, verifyLoggerGroup

LOGS = logging.getLogger("Smart Guard | الحارس الذكي")
...
try:
    LOGS.info("✧ بـدء تنزيـل الحارس الذكي ✧")
...
async def startup_process():
    ...
    print(f"⌔┊تـم تنصيـب الحارس الذكي . . بنجـاح ✓ \n⌔┊لـ إظهـار الاوامـر ارسـل (.الاوامر)")
    await verifyLoggerGroup()
